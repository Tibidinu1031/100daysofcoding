...
try:
  ...
  fileExists = False
  print("No previous task list found, starting a new one")
  print()
...
while True:
  ...
  if fileExists:
    try:
      ...
      pass
    backupFile = "backupTasks.plm"
    shutil.copy("tasklist.txt", f"Backup/{backupFile}")
